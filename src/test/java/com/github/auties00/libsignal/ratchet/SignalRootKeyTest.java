...
public class SignalRootKeyTest {
    ...
    public void testRootKeyDerivationV2() throws NoSuchAlgorithmException {
        ...
        var alicePublic = new byte[]{(byte) 0x05, (byte) 0xee, (byte) 0x4f, (byte) 0xa6, (byte) 0xcd,
        ...
        var alicePrivate = new byte[]{(byte) 0x21, (byte) 0x68, (byte) 0x22, (byte) 0xec, (byte) 0x67,
        ...
        var bobPublic = new byte[]{(byte) 0x05, (byte) 0xab, (byte) 0xb8, (byte) 0xeb, (byte) 0x29,
        ...
        var nextRoot = new byte[]{(byte) 0xb1, (byte) 0x14, (byte) 0xf5, (byte) 0xde, (byte) 0x28,
        ...
        var nextChain = new byte[]{(byte) 0x9d, (byte) 0x7d, (byte) 0x24, (byte) 0x69, (byte) 0xbc,
        ...
        var alicePublicKey = SignalIdentityPublicKey.ofDirect(alicePublic);
        var alicePrivateKey = SignalIdentityPrivateKey.ofDirect(alicePrivate);
        var aliceKeyPair = new SignalIdentityKeyPair(alicePublicKey, alicePrivateKey);
