...
public class HKDFTest {
    @Test
    public void testVectorV3() throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        var info = new byte[]{(byte) 0xf0, (byte) 0xf1, (byte) 0xf2, (byte) 0xf3, (byte) 0xf4,
                (byte) 0xf5, (byte) 0xf6, (byte) 0xf7, (byte) 0xf8, (byte) 0xf9};

        var okm = new byte[]{(byte) 0x3c, (byte) 0xb2, (byte) 0x5f, (byte) 0x25, (byte) 0xfa,
        ...
        var actualOutput = HKDF.of(3)
                .deriveSecrets(ikm, salt, info, 42);

        assertArrayEquals(okm, actualOutput);
    }

    public void testVectorLongV3() throws NoSuchAlgorithmException, InvalidKeyException {
        var ikm  = new byte[]{(byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x04,
        ...
        var salt = new byte[]{(byte) 0x60, (byte) 0x61, (byte) 0x62, (byte) 0x63, (byte) 0x64,
        ...
        var info = new byte[]{(byte) 0xb0, (byte) 0xb1, (byte) 0xb2, (byte) 0xb3, (byte) 0xb4,
        ...
        var okm  = new byte[]{(byte) 0xb1, (byte) 0x1e, (byte) 0x39, (byte) 0x8d, (byte) 0xc8,
        ...
        var actualOutput = HKDF.of(3)
                .deriveSecrets(ikm, salt, info, 82);
        assertArrayEquals(okm, actualOutput);
    }

    @Test
    public void testVectorV2() throws NoSuchAlgorithmException, InvalidKeyException {
        byte[] ikm = {0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b,
                0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b,
                0x0b, 0x0b};
        ...
        var okm = new byte[]{(byte) 0x6e, (byte) 0xc2, (byte) 0x55, (byte) 0x6d, (byte) 0x5d,
        ...
        var actualOutput = HKDF.of(2)
                .deriveSecrets(ikm, salt, info, 64);
        assertArrayEquals(okm, actualOutput);
    }
}
